  ...
  renderProductInfo() {
    ...
    fetch(
      ...
      .then((responseText) => {
        ...
        const destinationBottom = document.getElementById(`price-bottom-${this.dataset.section}`);
        const sourceBottom = html.getElementById(
          `price-bottom-${this.dataset.originalSection ? this.dataset.originalSection : this.dataset.section}`
        );
        ...
        if (sourceBottom && destinationBottom) destinationBottom.innerHTML = sourceBottom.innerHTML;
